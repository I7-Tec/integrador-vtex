...
public class DadosVtex {
    public static String sellers = "/catalog_system/pvt/seller";
    ...
    public static String endPointProdutoPorRefId = "/catalog_system/pvt/products/productgetbyrefid/";
    public static String endPointEstoque = "/logistics/pvt/inventory";
    public static String endPointCategoria = "/catalog/pvt/category";
